...
namespace HairStudio
{
    public class HairDressingToolkit
    {
        ...
        public void ChangeRoots(bool add) {
            ...
            if (add) {
                // we first locate the other root in the zone
                ...
                foreach (var root in dressing.roots.Get().ToList()) {
                    ...
                    if (toolToRoot.sqrMagnitude < MathUtility.Square(toolRadius) + MathUtility.Square(dressing.rootRadius)) {
        ...
        private bool IsBehindCollider(Vector3 pos) {
            ...
            return Physics.Raycast(pos + scalpToPos * 0.01f, toCam, 1000);
        }
